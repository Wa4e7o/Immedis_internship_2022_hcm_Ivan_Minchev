        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Employeer = table.Column<string>(maxLength: 30, nullable: true),
                    PositionName = table.Column<string>(maxLength: 45, nullable: true),
                    RecomendationLetter = table.Column<string>(maxLength: 70, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsRaiting = table.Column<int>(nullable: false),
                    FeedBack = table.Column<string>(maxLength: 250, nullable: false),
                    EmployeeDetailsId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
